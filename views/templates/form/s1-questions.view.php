    <form action="index.php?page=stepTest" method="post" class="max-w-lg mx-auto">
            <div>
                <?php                
        ...
        <div  class="flex space-y-4 justify-center sm:space-y-0">
            ...
            <button type="submit" id="next-button" name="page" value="stepTest"  class=" inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Suivant &nbsp;&nbsp;
                <svg class="w-3 h-3 text-white-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
